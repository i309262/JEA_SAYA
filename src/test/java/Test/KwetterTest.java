...
//
//        kweet1 = new Kweet("kweeter1's first tweet!", kweeter1);
//        kweet2 = new Kweet("kweeter2's first tweet!", kweeter2);
//        kweet3 = new Kweet("kweeter3's first tweet!", kweeter3);
//        kweet4 = new Kweet("kweeter4's first tweet!", kweeter4);
//        kweet5 = new Kweet("kweeter5's first tweet!", kweeter5);
//        kweet6 = new Kweet("kweeter6's first tweet!", kweeter6);
//        kweet7 = new Kweet("kweeter7's first tweet!", kweeter7);
//        kweet8 = new Kweet("kweeter8's first tweet!", kweeter8);
//        kweet9 = new Kweet("kweeter9's first tweet!", kweeter9);
//        kweet10 = new Kweet("kweeter10's first tweet!", kweeter10);
//
